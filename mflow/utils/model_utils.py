...
# from mflow.models.conditionalVAE_flow import MoFlow as Model
from mflow.models.graphvae_flow import MoFlow as Model
...
#     model.load_state_dict(torch.load(snapshot_path, map_location=device), strict=False)
    return model
